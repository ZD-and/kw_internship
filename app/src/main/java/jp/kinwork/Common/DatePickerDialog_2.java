...
public class DatePickerDialog_2 extends AlertDialog implements OnClickListener, OnDateChangedListener {
    ...
    public DatePickerDialog_2(Context context, OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth) {
        this(context, 0, callBack, year, monthOfYear, dayOfMonth);
    }


    public DatePickerDialog_2(Context context, int theme, OnDateSetListener callBack, int year, int monthOfYear,
                              int dayOfMonth) {
        super(context, theme);
        ...
        View view = inflater.inflate(R.layout.dialog_date_picker2, null);
        setView(view);
        mDatePickerStart = (DatePicker) view.findViewById(R.id.datePickerStart2);
    ...
    public void onDateChanged(DatePicker view, int year, int month, int day) {
        if (view.getId() == R.id.datePickerStart2)
